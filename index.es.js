...
export const getItem = function(key, isBroadcast) {
 ...
 */
export const setItem = function(key, value, isBroadcast) {
	/* 
			存储后的数据结构
			{
				time: 存储时间戳,
 ...
 * @param {Boolean} isBroadcast 默认为true
 */
export const removeItem = function(key, isBroadcast) {
...
export const initItems = function(){
	// TODO 获取当前items，也参与
	_broadcast({
		type: 'init',
